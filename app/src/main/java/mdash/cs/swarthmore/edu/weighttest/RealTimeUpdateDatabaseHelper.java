...
/**
 * Created by dredelm1 on 7/8/14.
 * NOTE: this db helper is THE SAME as DatabaseHelper, but with difference DB_NAME and TABLE_NAME
 */
public class RealTimeUpdateDatabaseHelper extends SQLiteOpenHelper {

    private static final int VERSION = 1;
    private static final String DB_NAME = "RealTimeChangingData";
    ...
    // Uri for update purposes
    public static final Uri URI_MY_TABLE = Uri.parse("sqlite://edu.swarthmore.cs.mdash.WeightTest.app/" + DB_NAME);

    public RealTimeUpdateDatabaseHelper(Context context) {
    ...
    public Cursor getData() {
        ...
        try {
            ...
            String query = "SELECT " + COL_EPOCH + " as _id, Weight, Date, Fat, Lean FROM " + TABLE_NAME;
